...
"
" Slightly edited by Zoresvit on 24.07.2010:
"   - changed cursorline and cursorcolumn color, removed most bolds
"
...
hi ColorColumn                            ctermbg=235 guibg=#202020 cterm=none
hi FoldColumn   ctermfg=248 guifg=#a8a8a8                     
hi Folded       ctermfg=255 guifg=#eeeeee ctermbg=60  guibg=#5f5f87
hi IncSearch    ctermfg=0   guifg=#000000 ctermbg=223 guibg=#ffdfaf cterm=none gui=none
hi NonText      ctermfg=248 guifg=#a8a8a8                           cterm=none gui=none
...
hi StatusLine                             ctermbg=240 guibg=#4e4e4e cterm=none gui=none
...
"" Syntax highlighting
hi Comment      ctermfg=175 guifg=#808080
hi Constant     ctermfg=229 guifg=#ffffaf
hi Error        ctermfg=15  guifg=#ffffff ctermbg=1   guibg=#800000
hi ErrorMsg     ctermfg=15  guifg=#ffffff ctermbg=1   guibg=#800000
hi Identifier   ctermfg=182 guifg=#dfafdf                           cterm=none
hi Ignore       ctermfg=238 guifg=#444444
hi LineNr       ctermfg=239 guifg=#4a4a4a ctermbg=233 guibg=#101010
...
"hi diffDelete                             ctermbg=186 guibg=#dfdf87 cterm=none gui=none
